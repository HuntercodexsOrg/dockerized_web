...
function refresh {
    ...
    echo ""
    echo "The refresh installation will be initialized !"
    echo "Continue ? Press [Enter] = Yes, or press [Ctrl+C] = No"
    read -n1 OP

    echo ""
    echo "Refresh Starting, please wait..."
    echo ""
...
if ! echo $PARAM1 | egrep -E '(delete|install|refresh)' >> /dev/null 2>&1
then
