...
ENV DIR_WWW "/var/www/dockerized_web"

RUN echo "DOCKERIZED WEB DOCKERFILE IS STARTING..."
...
RUN groupadd dockerized_web -g 999
RUN useradd dockerized_web -g dockerized_web -d $DIR_WWW
